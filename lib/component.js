...
(function (root, factory) {
  ...
  var mixin = Backbone.React.Component.mixin = class BackboneReactComponent extends React.Component {
  ...
  Backbone.React.Component.Mixin.childContextTypes = {
  ...
  // optional.
  Backbone.React.Component.Mixin.contextTypes = {
  ...
  _.extend(Wrapper.prototype, Backbone.Events, {
    ...
    onError(modelOrCollection, res, options) {
    ...
    onRequest(modelOrCollection, xhr, options) {
      // Set `state` only if there's no silent option
      if (!options.silent) {
        this.component.setState({
          isRequesting: true,
    ...
    setModels(models, initialState, isDeferred) {
    ...
    setCollections(collections, initialState, isDeferred) {
    ...
    setStateBackbone(modelOrCollection, key, target, isDeferred) {
    ...
    setState(modelOrCollection, key, target, isDeferred) {
      var state = {};
    ...
    startCollectionListeners(collection, key) {
  ...
  mixin.on = (component, backboneInstances) => {
